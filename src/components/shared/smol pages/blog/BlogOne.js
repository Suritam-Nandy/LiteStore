        ...
        <div>
            ...
            <section className="intro-single" style={{padding: '100px 0px 20px'}}>
                ...
                <div className="title-single-box">
                    <h1 className="title-single" style={{textAlign: 'center', fontFamily: '"Source Serif Pro"'}}>The Future of Retail: More Than Just Space - I</h1>
            ...
            <section className="news-single nav-arrow-b">
                ...
                <div className="row">
                    ...
                    <div className="post-content color-text-a">
                        <p style={{fontStyle: 'italic', textAlign: 'center', fontSize: '30px', paddingTop: '20px', fontFamily: '"Source Serif Pro", serif'}}>‘Physical Retail Isn’t dead. Boring Retail Is’ </p>
                        ...
                        <p>
                        In a popular <a href="https://floorplate.com/radio/doug-stephens/" target="_blank">podcast</a> covering the trends in the retail industry, an interesting idea was put forward. One of the speakers quipped  ‘Retail is the New Media and Online is the New Store’. It effectively conveys the idea that over the last few decades, there has been a complete role reversal between the medium of marketing and the medium of sales. With digital shopping being ubiquitous and a large chunk of sales taking place online, stores have to transition into the new medium for brands to market their product. 
                        </p>
                        <p style={{paddingTop: '10px'}}>
                        It is difficult to believe that many Fortune 500 brands today have opened multiple stores in different cities with no sales taking place in any of these stores. Yet this seems to be the new trend. What is it then that drives them to open these stores? The closest parallel that can be drawn to understand this, is to understand the economics going behind erecting billboard ads or even creating sensational advertisements on social media. No one is thinking in real terms of how much the brand earned directly in sales when the <a href="https://www.thebetterindia.com/71904/amul-girl-golden-jubilee/" target="_blank">Amul Girl</a> makes a witty remark on a billboard ad or when Rahul Dravid displays his anger issues in the <a href="https://www.youtube.com/watch?v=Im8-ymK-T_Y" target="_blank">Cred ad</a>. The idea of the ads far surpasses the metric of sales and ventures into more qualitative economic metrics which is: to inform, persuade and remind customers of the brand and its product along with creating a strong recall value. 
                        </p>
                        <p style={{paddingTop: '10px'}}>
                        The key to the future of retail also lies in adopting a strategy which focuses on experience, reach and innovation. Let us consider a stark example of this trend in the <a href="https://floorplate.com/radio/doug-stephens/" target="_blank">Cheetos campaign</a> in 2017. They ran a contest in which participants had to submit the wackiest Cheetos shapes they found in their bag of chips. The top prize winner took home a whopping $ 50,000. To display more than 100,000 entries, they opened a pop-up store in New York. Remember, no sales took place in the store. However, Cheetos recorded its strongest sales week ever, when the campaign led to <a href="https://www.prweek.com/article/1438231/instagram-trend-sparks-idea-cheetos-museum" target="_blank">4,831 media placements</a>.
                        </p>
                        <div className="news-img-box" style={{textAlign: 'center', paddingBottom: '20px'}}>
                        <img src="../assets/img/blog/cheetos.webp" style={{width: '50%', paddingBottom: '20px'}} alt="image" className="img-fluid" /> <br />
                        <a style={{color: '#000'}} href="https://www.image.com/50000-for-a-uniquely-shaped-cheeto-yup-the-cheetos-museum-is-ready-to-pay-up/">
                            Picture Credits:<span style={{color: '#7e7ca6'}}> Hungry Forever</span></a>
                        </div>
                    ...
                    <footer class="blockquote-footer">
                        ...
                        <p>
                        Let us look at another brand adopting a similar strategy but this time the store is situated in the busy street of Harajuku in Tokyo. Dohtonbori is a famous organic health food chain in Japan and in the year 2016, they opened up a temporary storefront at Harajuku which was <a href="https://floorplate.com/radio/doug-stephens/" target="_blank">quite bizarre!</a> The pop-up store had a neon red cross glowed behind the counter while two women in white lab coats showed customers scientific-charts and the pop-up had jars of pills stored everywhere. Look at the image below and you’d understand why it could easily pass off as a store conducting scientific experiments. However, a walk into the store revealed an entirely different concept. A closer look at the panel explained the concept succinctly: 
                        </p>
                        <p style={{paddingTop: '10px', fontStyle: 'italic', textAlign: 'center', fontWeight: 500}}>
                        ...
                        <p style={{paddingTop: '10px'}}>
                        There we are! Dohtonbori with a very smart marketing strategy was promoting their new restaurant opening in an adjacent area with a tag-line: “The healthy ingredients in Dohtonbori’s healthy okonomiyaki have all the nutrients you need". Similar to the Cheetos concept, nothing was sold at the pop-up store but the traffic at Dohtonbori increased by <a href="https://www.socialtables.com/blog/event-planning/pop-up-examples/" target="_blank">125 percent</a>. 
                        </p>
                        <div className="news-img-box" style={{textAlign: 'center', paddingBottom: '20px'}}>
                        <img src="../assets/img/blog/plus.webp" style={{width: '50%', paddingBottom: '20px'}} alt="image" className="img-fluid" /> <br />
                        <a style={{color: '#000'}} href="https://www.stylus.com/jvddnq">Picture Credits:<span style={{color: '#7e7ca6'}}> Stylus</span></a>
                        </div>
                        <p>
                        ...
                        In the following posts, we shall write more about the trends that the physical retail industry has been witnessing. Please do leave a comment below on what you think! 
                        </p>
                    </div>
                    </div>
                </div>
