  ...
  return(
    <div>
        ...
        <section id="head" className="d-flex align-items-center">
            ...
            <h1>LiteStore</h1>
            <h2 className="display-4" style={{color: 'aliceblue'}}><strong>Rent your own retail space, instantly
                <br />1 day | 1 week | 1 month<br />Long term Bookings</strong></h2>
            <a href="find-a-space.html" className="btn-get-started scrollto">Get Started</a>
            </div>
        </section>{/* End head */}
        {/*  Features Section  */}
        ...
        <div className="container" style={{textAlign: 'center'}}>
            ...
            <p>LiteStore is an online platform for listing and booking commercial retail 
            spaces which can be rented on an ultra short term basis.</p>
        </div>
        <div className="container" style={{textAlign: 'center'}}>
            <div className="row">
            <div className="feature-box col-sm">
                <i className="icon fas fa-store fa-4x" />
                <h3 className="feature-title">Find<br /> Space</h3>
            ...
            <div className="feature-box col-sm">
                ...
                <p>Choose your store layout and select from our list of add-on services</p>
            </div>
            <div className="col-sm arrow">
                <i className="icon fas fa-chevron-right fa-2x" />
            </div>
            <div className="feature-box col-sm" style={{padding: '5% 0% 3%'}}>
                ...
                <h3 className="feature-title">Book &amp;<br /> Pay</h3>
                <p>Enter into license agreements &amp; pay securely on our portal</p>
        ...
        <div className="container" data-aos="fade-up">
            ...
            <h2>India’s first online marketplace for short-term retail spaces. </h2>
            </div>
            <div className="row justify-content-md-center">
            <div className="col-lg-4 col-md-4 col-sm-12" data-aos="zoom-in" data-aos-delay={100}>
                ...
                <h4><a href="blank.html">Risk free booking</a></h4>
                <p>Streamlined contracts &amp; due diligence <br />for a hassle free experience</p>
                </div>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-12" data-aos="zoom-in" data-aos-delay={200}>
                ...
                <h4><a href="blank.html">Unprecedented Prices</a></h4>
                <p>We eliminate expensive lease payments,<br /> security deposits &amp; legal costs</p>
                </div>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-12" data-aos="zoom-in" data-aos-delay={100}>
                ...
                <h4><a href="blank.html">LiteStore Services</a></h4>
                <p>We provide PoS systems, staffing &amp;<br /> marketing analytics services</p>
                </div>
            </div>
            </div>
            <div className="row justify-content-md-center">
            <div className="col-lg-4 col-md-4 col-sm-12" data-aos="zoom-in" data-aos-delay={200}>
                ...
                <h4><a href="blank.html">Build unique retail<br /> experiences</a></h4>
                <p>Create buzz around your brand</p>
                </div>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-12" data-aos="zoom-in" data-aos-delay={300} style={{paddingLeft: '20px'}}>
                ...
                <h4><a href="blank.html">Launch with a bang!</a></h4>
                <p>Test new markets, products, strategies<br /> instantly at major commercial hubs</p>
                </div>
            </div>
            </div>
        </div>
