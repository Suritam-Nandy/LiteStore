...
const ListASpace = () => {
  return (
    <div>
      {/* <Helmet>
        <title>List A Space | LiteStore</title>
      </Helmet> */}
      {/*  Heading  */}
      <section
        className="head-section"
        style={{ paddingTop: "110px", backgroundColor: "#cdcbe76c" }}
      >
        <div className="container">
          <div className="row">
            <div className="col-md-12 col-lg-8" style={{ color: "#444" }}>
              <h1 className="title-single">List your space</h1>
              <h2 className="color-text-a" style={{ fontSize: "25px" }}>
                List your space for free and connect with brands, hassle free!
              </h2>
            </div>
      ...
      <section
        id="about-sec"
        className="about"
        style={{ paddingBottom: "0px", backgroundColor: "#cdcbe76c" }}
      >
        <div className="container">
          <div className="row content">
            <div className="col-lg-6 pt-4 pt-lg-0">
              <ul>
                <li>
                  <i className="fas fa-check" /> Our streamlined e-contracts
                  makes sure your listing is risk-free.{" "}
                </li>
                <li>
                  <i className="fas fa-check" /> Fix your Price | Hours | Ground
                  Rules
                </li>
                <li>
                  <i className="fas fa-check" /> Approve brands looking to rent
                  your space.
                </li>
              </ul>
            </div>
        ...
        <div className="container" style={{ textAlign: "center" }}>
          <div className="row">
            <div className="feature-boxes col-sm">
              ...
              <h3 className="feature-title" style={{ paddingBottom: "10px" }}>
                List space on <br />
                LiteStore
              </h3>
              <p>
                List your space and maximize your space’s potential through us.
              </p>
            </div>
            <div className="feature-boxes col-sm">
            ...
            <div className="feature-boxes col-sm">
              ...
              <p>
                Boost the value of your store with more eyes &amp; feet coming
                through each day.{" "}
              </p>
            </div>
            <div className="feature-boxes col-sm">
        ...
        <div className="container" style={{ textAlign: "center" }}>
          <div className="row">
            <div className="feature-box col-sm">
              ...
              <p>
                We ensure efficient <br />
                pricing and invoicing <br />
                management for a hassle <br />
                free experience.
              </p>
            </div>
            <div className="feature-box col-sm">
              ...
              <p>
                ...
                <br /> to manage opportunities
                <br /> and make data driven
                <br /> decisions for your portfolio
              </p>
            </div>
            <div className="feature-box col-sm">
              ...
              <p>
                Allow our team to <br />
                curate your space to <br />
                make it look minimal, <br />
                chic and charming
              </p>
            </div>
            <div className="feature-box col-sm">
              ...
              <p>
                Our team will ensure <br />
                thorough due diligence <br />
                of the property and <br />
