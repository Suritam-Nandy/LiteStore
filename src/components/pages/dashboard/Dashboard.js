...
const Dashboard = () => {
  ...
  return (
    <>
      <div className="flex flex-no-wrap bg-red-800">
        <button className="text-white z-50" onClick={() => setOpen(!open)}>
          {/* <FiMenu className="text-white z-50" /> */}
        </button>
        {/* Sidebar starts */}
        ...
        <div
          className={`${
            open ? "bg-gray-800" : "bg-gray-800"
          }w-64 absolute sm:relative bg-gray-800 shadow max-h-screen h-full flex-col justify-between hidden sm:flex`}
        >
          <div className="px-8">
            ...
            <ul className="mt-12">
              ...
              <li className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-sm  ml-2">Listed Spaces</span>
                </div>
                {/* <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">
                  5
                </div> */}
